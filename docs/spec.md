...
> _Nếu chúng ta không thật sự hiểu mình đang cần gì, thì AI chỉ là chiếc gương phản chiếu lại sự mơ hồ của chính chúng ta._
...
- **Tích hợp AI có định hướng (AI gợi ý câu hỏi, không trả lời thẳng).** Thay vì đưa đáp án, hệ thống nên hỏi ngược lại để kích thích tư duy.
  - _Ví dụ: Khi học sinh hỏi “Kết quả bài tập 3 là gì?”, hệ thống hỏi lại “Em đã thử cách nào rồi?”_
...
_\* Sản phẩm có thể là website hoặc ứng dụng điện thoại. Prototype / mockup có thể thay thế demo thực nếu chức năng AI chưa tích hợp đủ._
